...
ig.Entity = ig.Class.extend({
	...
	update: function() {
		...
		var screenEdgeX = ig.game.screen.x + 320;
		var screenEdgeY = ig.game.screen.y + 240;
		//check if item is within viewport on x 
		if(this.pos.x > ig.game.screen.x && this.pos.x < screenEdgeX && this.pos.y > ig.game.screen.y && this.pos.y < screenEdgeY){
	...
	draw: function() {
		...
		var screenEdgeY = ig.game.screen.y + 240;
		//check if item is within viewport on x 
		if(this.pos.x > ig.game.screen.x && this.pos.x < screenEdgeX && this.pos.y > ig.game.screen.y && this.pos.y < screenEdgeY && this.name == "point"){
			
			//console.log('drawing in entity.js');
			if( this.currentAnim ) {
